...
-- Insert sample hospital data for hospital1 user
INSERT IGNORE INTO hospitals (user_id, hospital_name, hospital_type, address, city, contact_person, contact_phone, contact_email, status) VALUES
